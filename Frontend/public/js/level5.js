...
function winner() {
	...
	var level_id = level;
	level++;
	var description = `Anda telah memainkan Level 5 dengan score ${score}`;
...
async function handleKey(e) {
	if ((e.key == "w" || e.key == "ArrowUp") && snake.direction !== "bottom") snake.direction = await "top";
	if ((e.key == "a" || e.key == "ArrowLeft") && snake.direction !== "right") snake.direction = await "left";
	if ((e.key == "d" || e.key == "ArrowRight") && snake.direction !== "left") snake.direction = await "right";
	if ((e.key == "s" || e.key == "ArrowDown") && snake.direction !== "top") snake.direction = await "bottom";
